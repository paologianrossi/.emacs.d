...
** Todo lists
   ...
   |-----------+-------------------+-------------------------------------------------------|
   | BACKLOG   | b                 | This task is in my backlog                            |
   | WEEK      | n ('next' in GTD) | This is planned and will be done in this week         |
   | TODAY     | t                 | I'm not doing this right now, but I think I will soon |
   ...
   #+begin_src emacs-lisp
          ...
          (setq org-todo-keywords
                (quote ((sequence "|" "BACKLOG(b)")
                        (sequence "WEEK(n)" "TODAY(t)" "|" "DONE(d)" "SOMEDAY(s)")
                        (sequence "WAITING(w@/!)" "DELEGATED(g@/!)" "|" "CANCELED(c@/!)" "MEETING(m)"))))

          (setq org-todo-keyword-faces
                (quote (("BACKLOG" :foreground "yellow" :weight bold)
   ...
   - Define what we can capture, and what template to use for each
     ...
     #+begin_src emacs-lisp
       (setq org-capture-templates
             (quote (("b" "backlog" entry (file "~/org/todo.org")
                      "* BACKLOG %?\n%U\n%a\n")
