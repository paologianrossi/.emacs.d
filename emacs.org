...
** Visuals
   ...
   - The default font (on a Mac) should be Source Code Pro (available [[https://github.com/adobe-fonts/source-code-pro][here]]), size 14, for my taste.
